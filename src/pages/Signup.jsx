...
function Signup() {
  ...
  return (
    <div>
      <Helmet>
        <title>Sign up - Equi Sports</title>
      </Helmet>
      <div className="hero bg-equi-primary-950">
          ...
          <div className="card bg-white bg-opacity-5 w-full shrink-0 shadow-2xl">
            ...
            <form onSubmit={handleSignUp} className="card-body">
              ...
              <div className="form-control mt-6">
                <button className="btn bg-equi-primary-500 border-none text-white hover:bg-success-primary-500">
                  Sign up
                </button>
